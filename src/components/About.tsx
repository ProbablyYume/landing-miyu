...
const socials: Social[] = [
  {
    name: 'Twitch',
    url: 'https://twitch.tv/miyuvalkyrie',
    color: '#9146ff',
  ...
  {
    name: 'Kick',
    url: 'https://kick.com/miyuvalkyrie',
    color: '#00E701',
    icon: 'kick',
    customSvg: (
      <svg
  ...
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@MiyuValkyrie',
    color: '#FF0000',
    icon: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z',
  },
  {
    name: 'Steam',
    url: 'https://steamcommunity.com/id/miyuvalkyrie/',
    color: '#171a21',
    icon: 'steam',
    customSvg: (
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/miyuvalkyrie/',
    color: '#E4405F',
  ...
  {
    name: 'Club',
    url: 'https://club.com/miyuvalkyrie',
    color: '#6f4cff',
    icon: 'club',
    customSvg: (
      <img
        src="https://club.com/images/favicons/club-favicon-192x192.png"
        alt="Club"
  ...
  {
    name: 'X (Twitter)',
    url: 'https://x.com/MiyuValkyrie',
    color: '#000000',
    icon: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z',
  },
  {
    name: 'Discord',
    url: 'https://discord.com/invite/CX5wXNZ',
    color: '#5865F2',
    icon: 'discord',
    customSvg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="71" height="80" viewBox="0 0 71 80" fill="currentColor">
  ...
  {
    name: 'TikTok',
    url: 'https://www.tiktok.com/@miyuvalkyrie',
    color: '#000000',
  ...
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/lmiyuvalkyrie/',
    color: '#1877F2',
    icon: 'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z',
  },
  {
    name: 'Email',
    url: 'mailto:miyuvalkyrie@gmail.com',
    color: '#b00000',
    ...
    <section id="about" className="about-section">
      ...
      <div className="about-container">
        ...
        <div className="about-text">
          ...
          <h3 className="about-socials-title">{t.socials.title}</h3>
            ...
            {socials.map((social) => {
              ...
              return (
                ...
                >
                  {social.customSvg ? (
                    <div
                      className={`about-social-icon-custom ${
                        social.name === 'Kick' ? 'about-social-icon-kick' : ''
                      }`}
                    >
                      {social.customSvg}
                    </div>
